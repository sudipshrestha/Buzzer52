...
DROP TABLE IF EXISTS webCrawl.page;
CREATE TABLE webCrawl.page
(
    ...
    is_loaded			int(11) DEFAULT NULL,
    PRIMARY KEY (page_id),
    key `page_link`(page_link)
);

-- ALTER TABLE webCrawl.page ADD column is_loaded int(11) DEFAULT NULL;
-- SELECT * FROM webCrawl.page;
-- UPDATE webCrawl.page SET is_loaded = 0 where page_id in(1,2);
-- INSERT INTO webCrawl.page(is_loaded) VALUES (0);
-- DELETE FROM webCrawl.page where page_id = 3;

DROP TABLE IF EXISTS webCrawl.page_tags;
CREATE TABLE webCrawl.page_tags
(
...
CREATE TABLE `page_details` (
  ...
  PRIMARY KEY (`page_id`)
 # CONSTRAINT `page_details_ibfk_1` FOREIGN KEY (`page_id`) REFERENCES `page` (`page_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;


INSERT INTO webCrawl.page(page_link, page_shortlink) 
...
INSERT INTO webCrawl.page_tags(page_link, tags)
...
SELECT * FROM webCrawl.page_tags;


INSERT INTO webCrawl.page_details(page_id, page_link, title, image, brand, ratings, features, price )
...
CREATE TABLE webCrawl.page_details
(
...
DROP TABLE IF EXISTS webCrawl.pinterest_image;
CREATE TABLE webCrawl.pinterest_image
(
    page_id             BIGINT(20) unsigned,
    page_link           VARCHAR(255) NOT NULL,
